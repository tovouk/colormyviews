package com.josehinojo.colormyviews

import android.graphics.Color
import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.view.View
import com.josehinojo.colormyviews.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    fun makeColored(view: View) {
        when (view.id) {
            ...
            //when clicking red, yellow, and green buttons change box backgrounds to said color
